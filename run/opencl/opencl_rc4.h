...
#else
#define KEY8(t, k)  (((k) & 3) + (((k) / 4) * 128) + (((t) & 31) * 4))
#define KEY32(t, k) (((k) * 32) + ((t) & 31))
#endif
...
#define GETSTATE(n)      GETCHAR_L(ctx->state, KEY8(lid, n))
#define PUTSTATE(n, v)   PUTCHAR_L(ctx->state, KEY8(lid, n), v)
#define PUTSTATE32(n, v) ctx->state[KEY32(lid, n)] = v
#define STATE(n)         ctx->n[lid]
...
#define GETSTATE(n)      GETCHAR(ctx->state, n)
#define PUTSTATE(n, v)   PUTCHAR(ctx->state, n, v)
#define PUTSTATE32(n, v) ctx->state[n] = v
#define STATE(n)         ctx->n
#endif
